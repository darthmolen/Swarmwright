...
Every factual claim and counterargument MUST include provenance. Use these formats:
...
Skeptical claims are held to the same citation standard as primary claims. "Studies suggest otherwise" without a URL is as weak as the unsourced claim you are challenging.
